...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("F (Estados finales) =");

        jLabel2.setText("Q (Total de estados) =");
 
        alfabetoLabel.setText("[no se ingresó ningún alfabeto]");

        jLabel1.setText("Σ (Alfabeto) =");
        ...
        opcionTransiciones.setText("Mostar Tabla de Transiciones");
    ...
    private void opcionNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opcionNuevoActionPerformed
        if(JOptionPane.showConfirmDialog(this, "Se va a generar un nuevo AFD. ¿Desea continuar?", null, JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
            try{            
                ...
                JOptionPane.showMessageDialog(this, "No se pudo crear correctamente el AFD", "Error, estas chavo!", JOptionPane.ERROR_MESSAGE);
            }
        }        
    ...
    private void ingresarTransiciones() {
        JOptionPane.showMessageDialog(this, "EXCELENTE! Ahora a la tabla de transiciones", "", JOptionPane.INFORMATION_MESSAGE);
        /*
