...
public class MainBioritmo extends JFrame
{
   ...
   public boolean action(Event ev, Object ar)
   {
      ...
      {
         /*bandera=true;
         mensaje = diaN.getText();
         repaint();*/
         try
         {
            diaNacimiento = Double.parseDouble(diaN.getText());
            mesNacimiento = Double.parseDouble(diaN.getText());
            anioNacimiento = Double.parseDouble(diaN.getText());
   ...
   public void paint(Graphics g)
   {
      ...
      dv1 = diasVividos%23;
      for(double x=dv1-20; x<=dv1+20; x+=0.01)
      {               
         y=(x*2*Math.PI)/23;
         y=Math.sin(y); 
         y=y*-1;
      ...
      dv2 = diasVividos%28;
      for(double x=dv2-40; x<=dv2+20; x+=0.01)
      {               
         y=(x*2*Math.PI)/28;
         y=Math.sin(y); 
         y=y*-1;        
      ...
      dv3 = diasVividos%33;
      for(double x=dv3-40; x<=dv3+20; x+=0.01)
      {               
         y=(x*2*Math.PI)/33;
         y=Math.sin(y); 
         y=y*-1;      
      ...
      //ETIQUETA
      g.setColor(Color.BLACK);
      g.drawRect(900,500,300,150);
      g.drawRect(901,501,300,150);
      g.drawRect(902,502,300,150);
      
      g.drawString("Dias vividos:  "+dv,910,530);
      g.drawString("Dia actual ciclo fisico:  "+dv1,910,545);
      g.drawString("Dia actual ciclo emocional:  "+dv2+".",910,560);
      g.drawString("Dia actual ciclo intelectual:  "+dv3,910,575);
