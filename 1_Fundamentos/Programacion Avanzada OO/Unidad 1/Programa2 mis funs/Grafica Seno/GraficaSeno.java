   ...
   public GraficaSeno()
	{
		...
		setTitle("Gráfica de la función Seno");
		setSize(1000,700);
		setVisible(true);
	}
	...
	public void paint(Graphics g)
	{
		...
		g.setFont(letrero);
		g.drawString("Gráfica f(x) = seno",42,60);
      ...
      g.drawString("|",960,355);
		...
		Font letrero2 = new Font("SansSerif", Font.ITALIC,12);
		g.setFont(letrero2);
      ...
      {			     			    			     
		...
		for(int ex = 0; ex < 450; ex++)
		    {
		    	ex3 = ex2 + 2;                               
		    	g.drawLine((int)(ex2),(int)(350-(ey[ex])*175),ex3,(int)(350-(ey[ex+1])*175));
